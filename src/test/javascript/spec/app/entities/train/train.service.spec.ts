    ...
    describe('Train Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/trains';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Train', () => {
                service.create(new Train(null)).subscribe(received => {
            ...
            it('should update a Train', () => {
                service.update(new Train(123)).subscribe(received => {
